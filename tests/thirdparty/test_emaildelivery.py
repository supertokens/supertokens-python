...
@mark.asyncio
async def test_email_verify_default_backward_compatibility_supress_error(driver_config_client: TestClient):
...
async def test_email_verify_custom_override(driver_config_client: TestClient):
    ...
    def email_delivery_override(oi: EmailDeliveryInterface[TypeThirdPartyEmailDeliveryInput]):
        ...
        async def send_email(input_: TypeThirdPartyEmailDeliveryInput, user_context: Dict[str, Any]):
            nonlocal email, email_verify_url
...
async def test_email_verify_smtp_service(driver_config_client: TestClient):
    ...
    def smtp_service_override(oi: SMTPServiceInterface[TypeThirdPartyEmailDeliveryInput]):
        ...
        async def get_content_override(input_: TypeThirdPartyEmailDeliveryInput, _user_context: Dict[str, Any]) -> EmailContent:
    ...
    def email_delivery_override(oi: EmailDeliveryInterface[TypeThirdPartyEmailDeliveryInput]) -> EmailDeliveryInterface[TypeThirdPartyEmailDeliveryInput]:
        ...
        async def send_email_override(input_: TypeThirdPartyEmailDeliveryInput, user_context: Dict[str, Any]):
