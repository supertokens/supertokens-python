...
from supertokens_python.emailpassword.recipe_implementation import RecipeImplementation as EmailPasswordImplementation
from supertokens_python.thirdparty.recipe_implementation import RecipeImplementation as ThirdPartyImplementation
