...
from ..interfaces import EmailPasswordSignInOkResult, EmailPasswordSignInWrongCredentialsError
...
def emailpassword_sign_in(email: str, password: str, user_context: Union[None, Dict[str, Any]] = None) -> Union[EmailPasswordSignInOkResult, EmailPasswordSignInWrongCredentialsError]:
    from supertokens_python.recipe.thirdpartyemailpassword.asyncio import \
...
def update_email_or_password(
        user_id: str, email: Union[None, str] = None, password: Union[None, str] = None, user_context: Union[None, Dict[str, Any]] = None):
    from supertokens_python.recipe.thirdpartyemailpassword.asyncio import \
