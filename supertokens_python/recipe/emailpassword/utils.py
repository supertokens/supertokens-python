...
def default_get_reset_password_url(
    ...
    """default_get_reset_password_url.
...
class InputSignUpFeature:
    ...
    def __init__(self, form_fields: Union[List[InputFormField], None] = None):
        ...
        Parameters
        ----------
        form_fields : Union[List[InputFormField], None]
            form_fields
        """
...
def validate_and_normalise_sign_in_config(
    ...
    """validate_and_normalise_sign_in_config.
...
class InputResetPasswordUsingTokenFeature:
    ...
    def __init__(self,
        ...
        create_and_send_custom_email : Union[Callable[[User, str, Dict[str, Any]], Awaitable[None]], None]
