...
from supertokens_python.recipe.emailverification.types import User, EmailVerificationEmailTemplateVarsUser, \
...
class APIImplementation(APIInterface):
    ...
    async def generate_email_verify_token_post(self, api_options: APIOptions, user_context: Dict[str, Any]) -> Union[GenerateEmailVerifyTokenPostOkResult, GenerateEmailVerifyTokenPostEmailAlreadyVerifiedError]:
        ...
        email_delivery_user = EmailVerificationEmailTemplateVarsUser(user.user_id, user.email)
        email_verification_email_delivery_input = EmailVerificationEmailTemplateVars(
