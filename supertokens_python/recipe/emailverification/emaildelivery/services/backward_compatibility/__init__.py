...
from supertokens_python.recipe.emailverification.types import User, VerificationEmailTemplateVars
...
class BackwardCompatibilityService(EmailDeliveryInterface[VerificationEmailTemplateVars]):
    def __init__(self,
                 app_info: AppInfo,
