...
class EmailVerificationEmailTemplateVarsUser:
    def __init__(self, user_id: str, email: str):
        self.id = user_id
        self.email = email


class EmailVerificationEmailTemplateVars:
    def __init__(
        self,
        user: EmailVerificationEmailTemplateVarsUser,
...
# Export:
EmailTemplateVars = EmailVerificationEmailTemplateVars
