...
class SessionConfig:
    def __init__(
        ...
        default_jwk_refresh_interval_sec: int,
    ):
        ...
        self.mode = mode
        self.default_jwk_refresh_interval_sec = default_jwk_refresh_interval_sec
...
def validate_and_normalise_user_input(
    ...
    if default_jwk_refresh_interval_sec is None:
        default_jwk_refresh_interval_sec = 4 * 3600  # 4 hours
