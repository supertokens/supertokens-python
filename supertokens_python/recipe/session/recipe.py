...
from .utils import validate_and_normalise_user_input, InputErrorHandlers, OverrideConfig
...
class SessionRecipe(RecipeModule):
    ...
    async def verify_session(self, request: BaseRequest, anti_csrf_check: Union[bool, None] = None,
        ...
        return await self.api_implementation.verify_session(
            APIOptions(request, None, self.recipe_id, self.config, self.recipe_implementation), anti_csrf_check,
            session_required)
