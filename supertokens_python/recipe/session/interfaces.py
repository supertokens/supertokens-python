...
class SessionContainer(ABC):  # pylint: disable=too-many-public-methods
    ...
    async def attach_to_request_response(
        self, request: BaseRequest, transfer_method: TokenTransferMethod, user_context: Dict[str, Any]
    ):
        pass
    ...
    def sync_attach_to_request_response(
        self, request: BaseRequest, token_transfer: TokenTransferMethod, user_context: Dict[str, Any]
    ) -> None:
        return sync(self.attach_to_request_response(request, token_transfer, user_context))
