...
def create_jwt(payload: Dict[str, Any], validity_seconds: Union[None, int] = None, user_context: Union[None, Dict[str, Any]] = None) -> Union[CreateJwtResultOk, CreateJwtResultUnsupportedAlgorithm]:
    from supertokens_python.recipe.session.asyncio import \
