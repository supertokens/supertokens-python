...
def get_session(request, anti_csrf_check: Union[bool, None] = None, session_required: bool = True,
    ...
    return sync(async_get_session(request, anti_csrf_check, session_required, user_context))
...
def revoke_multiple_sessions(session_handles: List[str], user_context=None) -> List[str]:
...
def update_session_data(session_handle: str, new_session_data: dict, user_context=None) -> None:
