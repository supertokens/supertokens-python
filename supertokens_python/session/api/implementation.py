...
from supertokens_python.session.interfaces import APIInterface, SignOutOkayResponse
from supertokens_python.utils import normalise_http_method

if TYPE_CHECKING:
    from supertokens_python.session.interfaces import APIOptions, SignOutResponse
